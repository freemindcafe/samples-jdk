...
public class EchoClientTest {
	...
	public void simple_client_connectes_with_server_succeeds_as_client_keystore_has_server_public_certificate_and_server_keystore_has_cleint_public_cer(){
		try {
			...
			System.setProperty(
					"javax.net.ssl.trustStore",currentDir()+"/src/com/freemindcafe/socket/ssl/sample2/clientkeystore.jks");
			System.setProperty("javax.net.ssl.trustStorePassword", "password");
			System.setProperty(
					"javax.net.ssl.keyStore",
					currentDir()+"/src/com/freemindcafe/socket/ssl/sample2/clientkeystore.jks");
