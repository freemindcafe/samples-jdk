...
public class EchoClientTest {
	...
	public void simple_client_connectes_with_server_succeeds_as_we_use_custom_key_manager_to_choose_serverkey(){
		try {
			...
			System.setProperty(
					"javax.net.ssl.trustStore",currentDir()+"/src/com/freemindcafe/socket/ssl/sample5/clientkeystore.jks");
			System.setProperty("javax.net.ssl.trustStorePassword", "password");
			System.setProperty(
					"javax.net.ssl.keyStore",
					currentDir()+"/src/com/freemindcafe/socket/ssl/sample5/clientkeystore.jks");
