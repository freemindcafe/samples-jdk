...
public class EchoClientTest {
	...
	public void simple_client_connectes_with_server_fails_as_server_presents_serverkey1_and_client_has_the_public_cert_of_serverkey(){
		try {
			...
			System.setProperty(
					"javax.net.ssl.trustStore",currentDir()+"/src/com/freemindcafe/socket/ssl/sample4/clientkeystore.jks");
			System.setProperty("javax.net.ssl.trustStorePassword", "password");
			System.setProperty(
					"javax.net.ssl.keyStore",
					currentDir()+"/src/com/freemindcafe/socket/ssl/sample4/clientkeystore.jks");
